...
from results.results_unetplusplus_exp_B.unetplusplus import SmallNestedUNet
...
if __name__ == "__main__":
    evaluate('../semantic/valid', '../semantic/valid_masks', 'results/results_unetplusplus_exp_B/best_unet_model.pth')
